...
public class ZodiacDao {
    ...
    public static void addUser(User user) throws SQLException{
       ...
       /* public void viewUserById() throws SQLException{
            //Not sure about what how to  retrieve data here as id is nor given as parameter
        }*/
		...
		try {
			...
			{   id = rs.getInt(1);
				...
				userdistrict=rs.getString(5);
				 ms=new User(username,userbirthdate,userbirthtime,userdistrict);
				ms.setUserId(id);
    ...
    public static List<User> list() throws SQLException 
	{
		...
		ConnectionManager tc=new ConnectionManager();
		List<User> ms = new ArrayList<User>();
		try {
			String username,userbirthdate,userbirthtime,userdistrict;
            int id;
